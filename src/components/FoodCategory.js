...
const FoodCategory = ({ data, showItems, setOpenAccordianIndex }) => {
  ...
  return (
    <div
      ...
      className="mx-auto shadow-lg bg-gray-50 p-2 my-4 text-left"
    >
      ...
      {showItems && (
        <div>
          {itemCards.map((item) => (
            <div
              className="my-4 py-6 flex border-b-2 border-gray-200"
            ...
            >
              ...
              <div className="relative p-4 w-3/12">
                <button className="absolute bottom-1 left-12 shadow-xl bg-white text-green-400 px-6 py-2 rounded-lg">
                  Add
                </button>
                <img
